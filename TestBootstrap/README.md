...
* TestBootstrap is now API 15+ only.
* I will also be implementing RxJava, Material design and a few other things into this app as well.
There will be *no upgrade path* as TestBootstrap is mean to act as a starting point for Android Applications.

# TestBootstrap App

[![Build Status](https://travis-ci.org/AndroidBootstrap/doraieun-testbootstrap.svg?branch=master)](https://travis-ci.org/AndroidBootstrap/doraieun-testbootstrap)

This repository contains the source code for the [TestBootstrap](http://www.androidbootstrap.com/)
Android app available from [Google Play](https://play.google.com/store/apps/details?id=doraieun.TestBootstrap).

Please see the [issues](https://github.doraieun.TestBootstrap/doraieun-testbootstrap/issues) section
to report any bugs or feature requests and to see the list of known issues.

Have a questions about TestBootstrap? Ask away on the [doraieun-testbootstrap discussion forum](https://groups.google.com/forum/#!forum/doraieun-testbootstrap).

<a href="https://play.google.com/store/apps/details?id=doraieun.TestBootstrap" alt="Download from Google Play">
...
code for the app will change:
  ...
  - From: __doraieun.TestBootstrap__
  - To: __com/notify/app/mobile__

At that point all the source files that were located in ____doraieun.TestBootstrap__ will be moved to the
new folder __com/notify/app/mobile__.

All import statments that reference the old resources (__R.doraieun.TestBootstrap.R__) will now be renamed
...
signed with a different key.  Manually uninstall TestBootstrap from your device and
...
TestBootstrap is a result of a template project I've developed over the years as well as
...
TestBootstrap is built on the awesome [Parse.com API](http://www.parse.com/)
...
## Contributors
Thank you to all the [contributors](http://www.github.doraieun.TestBootstrap/doraieun-testbootstrap/contributors) on
...
[pull requests](https://github.doraieun.TestBootstrap/doraieun-testbootstrap/pulls).
