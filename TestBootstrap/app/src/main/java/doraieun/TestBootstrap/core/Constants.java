...
public final class Constants {
    ...
    public static final class Auth {
         ...
         * Account type id
         */
        public static final String BOOTSTRAP_ACCOUNT_TYPE = "doraieun.TestBootstrap";

        /**
         * Account name
         */
        public static final String BOOTSTRAP_ACCOUNT_NAME = "TestBootstrap";

        /**
         * Provider id
         */
        public static final String BOOTSTRAP_PROVIDER_AUTHORITY = "doraieun.TestBootstrap.sync";
    ...
    public static final class Intent {
         ...
         */
        public static final String INTENT_PREFIX = "doraieun.TestBootstrap.";
