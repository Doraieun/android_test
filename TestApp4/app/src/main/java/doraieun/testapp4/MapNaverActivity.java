 ...
 */
public class MapNaverActivity extends NMapActivity implements NMapView.OnMapStateChangeListener, NMapView.OnMapViewTouchEventListener {
    ...
    private void restoreInstanceState() {
        ...
        System.out.println("LocationManager : " + lm);
...
//        nMapController.setMapViewBicycleMode(bicycleMode);
        ...
        nMapController.setMapCenter(new NGeoPoint(128.63102279999998, 35.2159626), level);
